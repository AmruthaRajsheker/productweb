...
<html lang="en">
    <head>
        ...
        .home{
            height: 3000px;
            width: 85%;
            border: 12px solid : darkolivegreen;
            padding-left:10px;
            padding-right:10px;
            margin-left: auto;
            margin-right:auto;
    ...
    <body>
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    <div class="text">
                    <p><h2><u>BOARD MEMBERS</u></h2> </p>
                    <h4><u>Chairman</u></h4>
                    </div>
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Amrutha Rajsheker<h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Arya</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Sanjitha</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Sowmya</h2></b></p></div>
                    <div class="amph2"></div>
